...
The goal of `palettehelper` is to help you build and manage color palettes in R for data viz. I mostly made it for myself! And as a test package for customizing content in the Fisheries Integrated Toolbox documentation.
